...
namespace CustomToDoManager.SlowService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SlowService.IToDoManager")]
    public interface IToDoManager {
        ...
        CustomToDoManager.SlowService.ToDoItem[] GetTodoList(int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/GetTodoList", ReplyAction="http://tempuri.org/IToDoManager/GetTodoListResponse")]
        System.Threading.Tasks.Task<CustomToDoManager.SlowService.ToDoItem[]> GetTodoListAsync(int userId);
        ...
        void UpdateToDoItem(CustomToDoManager.SlowService.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/UpdateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/UpdateToDoItemResponse")]
        System.Threading.Tasks.Task UpdateToDoItemAsync(CustomToDoManager.SlowService.ToDoItem todo);
        ...
        void CreateToDoItem(CustomToDoManager.SlowService.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/CreateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/CreateToDoItemResponse")]
        System.Threading.Tasks.Task CreateToDoItemAsync(CustomToDoManager.SlowService.ToDoItem todo);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IToDoManagerChannel : CustomToDoManager.SlowService.IToDoManager, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ToDoManagerClient : System.ServiceModel.ClientBase<CustomToDoManager.SlowService.IToDoManager>, CustomToDoManager.SlowService.IToDoManager {
        ...
        public CustomToDoManager.SlowService.ToDoItem[] GetTodoList(int userId) {
            return base.Channel.GetTodoList(userId);
        }
        
        public System.Threading.Tasks.Task<CustomToDoManager.SlowService.ToDoItem[]> GetTodoListAsync(int userId) {
            return base.Channel.GetTodoListAsync(userId);
        }
        
        public void UpdateToDoItem(CustomToDoManager.SlowService.ToDoItem todo) {
            base.Channel.UpdateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task UpdateToDoItemAsync(CustomToDoManager.SlowService.ToDoItem todo) {
            return base.Channel.UpdateToDoItemAsync(todo);
        }
        
        public void CreateToDoItem(CustomToDoManager.SlowService.ToDoItem todo) {
            base.Channel.CreateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task CreateToDoItemAsync(CustomToDoManager.SlowService.ToDoItem todo) {
